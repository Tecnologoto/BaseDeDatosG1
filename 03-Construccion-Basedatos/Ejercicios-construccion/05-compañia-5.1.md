...
CREATE TABLE project(
    name VARCHAR(20) NOT NULL,
    project_code VARCHAR(20) NOT NULL, -- Renombrado para evitar confusi�n con el nombre de la tabla
...
## Modelo E-R
![Compañia](../../img/E%20-%20R/Ejercicio5.1-y-5.2.png)

## Modelo Relacional
![Compañia](../../img/Relacional/Ejercicio5.1.jpg)

## Modelo Relacional SQL
![Compañia](../../img/RelacionalSQL/05-5.1-compañia.png)